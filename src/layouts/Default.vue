<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 top-border">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div class="header">
            <a v-if="$route.path === '/'" class="text-copy-primary hover:text-gray-600">JavaScript</a>
            <g-link v-else to="/" class="text-copy-primary hover:text-gray-600">JavaScript Jeep</g-link>
        </div>
    ...
    <footer class="text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:jagathish1123@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/jagathish1123" target="_blank" class="text-white hover:text-gray-400">
